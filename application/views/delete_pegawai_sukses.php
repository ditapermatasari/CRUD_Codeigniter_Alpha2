		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										...
										<li><a href="<?php echo site_url('pegawai/create') ?>">Tambah Pegawai</a></li>
									</ul>
								</div><!-- /.navbar-collapse -->
						</div>
						</nav>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="alert alert-success" role="alert">Delete Data Berhasil</div>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/') ?>" type="button" class="btn btn-warning">Delete</a>
										</td>
